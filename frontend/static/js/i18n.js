...
const TRANSLATIONS = {
  zh: {
    ...
    "toolbox.title": "工具箱",
    "toolbox.pick_docs": "从文献库选择",
    "toolbox.dropzone_text": "拖拽 PDF 到此处，或点击选择本地文件",
    "toolbox.remove_local": "移除",
    "toolbox.upload_failed": "上传失败：",
    "toolbox.search_placeholder": "搜索标题 / 文件名...",
    "toolbox.pick_tool": "选择工具",
    "toolbox.tool_merge": "合并 PDF",
    "toolbox.run": "执行",
    "toolbox.running": "执行中...",
    ...
    // ── Settings ──
    "settings.title": "账户设置",
    "settings.keys_label": "API Key（支持多秘钥并发轮询）",
  ...
  en: {
    ...
    "toolbox.pick_docs": "Pick from library",
    "toolbox.dropzone_text": "Drag a PDF here, or click to pick a local file",
    "toolbox.remove_local": "Remove",
    "toolbox.upload_failed": "Upload failed: ",
    "toolbox.search_placeholder": "Search title / filename...",
    "toolbox.pick_tool": "Choose a tool",
    "toolbox.tool_merge": "Merge PDFs",
    "toolbox.run": "Run",
    ...
    "chat.tools": "Tools",
    "chat.tool_dpi_label": "Export DPI",
    ...
    "settings.keys_label": "API Key (supports multiple keys, rotated across requests)",
