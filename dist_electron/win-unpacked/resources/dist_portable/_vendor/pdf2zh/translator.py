    ...
    def translate(self, text):
        response = self.client.chat(
            ...
            messages=[
                ...
                {
                    "role": "user",
                    "content": f"Translate the following markdown source text to {self.lang_out}. Keep any placeholders like $v0$, $v1$, $v2$, etc. exactly as they are in the source text, without modifying or deleting them. Do not explain or add extra text. Output ONLY the translated text.\nSource Text: {text}\nTranslated Text:",
                },
            ],
        )
        ...
        response = self.client.chat.completions.create(
            ...
            **self.options,
            messages=[
                ...
                {
                    "role": "user",
                    "content": f"Translate the following markdown source text to Simplified Chinese. Keep any placeholders like $v0$, $v1$, $v2$, etc. exactly as they are in the source text, without modifying or deleting them. Do not explain or add extra text. Output ONLY the translated Chinese text.\nSource Text: {text}\nTranslated Text:",
                },
            ],
        )
