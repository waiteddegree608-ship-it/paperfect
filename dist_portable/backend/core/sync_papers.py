    ...
    try:
        ...
        for item in items:
            ...
            doc = Document(
                ...
                research_field=json.dumps(analysis.get("research_field", ""), ensure_ascii=False) if isinstance(analysis.get("research_field"), dict) else str(analysis.get("research_field", "")),
                research_direction=json.dumps(analysis.get("research_direction", ""), ensure_ascii=False) if isinstance(analysis.get("research_direction"), dict) else str(analysis.get("research_direction", "")),
